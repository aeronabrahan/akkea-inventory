...
def load_users():
    return {
        "admin": {
            # password: admin
            "password": b"$2b$12$LZJhrYxJXQ6vZYxzqKfq9ubtNEn6XT8u7NT0J0uHez8LCK6uKUcHG",
            "role": "admin"
        },
        "staff": {
            # password: staff
            "password": b"$2b$12$5F8K5sToXUqvJw3KxM5peOBFD7cI6Fu3Ygu3YarFv4l7EZaN4iFYK",
            "role": "staff"
        }
    }
    ...
    if login_btn:
        if username in users:
            ...
            if isinstance(hashed, str):
                hashed = hashed.encode()  # Just in case someone mistakenly commits it as a string
